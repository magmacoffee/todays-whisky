  ...
  return (
    <>
      ...
      <Content>
        ...
        <br />
        <Text.H5>
          같이 소통하고 나누는 것을 좋아해서 직접 스터디도 직접 개설하여 운영하거나 참여하며 다양한 활동을 하고 있습니다.
        </Text.H5>
        <Text.H5>
          현재 진행중인 프로젝트는 2022 관광데이터 활용 공모전(한국관광공사, 카카오 주관)에 
          <br />
          11명의 팀원들과 HEVER라는 이름으로 참가하여 백엔드 리더 역할을 맡고 있어요!
        </Text.H5>
        <Text.H5>
          그리고 요즘 백엔드는 JPA, 프론트는 리액트를 공부하고 있습니다.
        </Text.H5>
        <Icons>
